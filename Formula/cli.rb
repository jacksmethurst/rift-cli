class Cli < Formula
  ...
  homepage "https://github.com/New-Genre/rift-cli"
  version "1.0.0"

  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/New-Genre/rift-cli/releases/download/v1.0.0/rift-darwin-amd64.tar.gz"
      sha256 "REPLACE_WITH_ACTUAL_SHA256_FOR_INTEL"
    end
    if Hardware::CPU.arm?
      url "https://github.com/New-Genre/rift-cli/releases/download/v1.0.0/rift-darwin-arm64.tar.gz"
