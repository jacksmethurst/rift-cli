class Rift < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/jacksmethurst/rift-cli/releases/download/v1.0.1/rift-darwin-amd64.tar.gz"
      sha256 "REPLACE_WITH_ACTUAL_SHA256_FOR_INTEL"
    end
    if Hardware::CPU.arm?
      url "https://github.com/jacksmethurst/rift-cli/releases/download/v1.0.1/rift-darwin-arm64.tar.gz"
